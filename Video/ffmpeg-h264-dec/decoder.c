...
static void streamInit(Stream *stream, u32 length) {
	printf("shashi:decode:streamInit\n");
...
static void outputFrame (AVFrame *frame) {
	printf("shashi:decode:outputFrame\n");
...
static int decodePacket(AVPacket *packet, int flush) {
	printf("shashi:decode:decodePacket\n");
    int got_frame = 0;
    do {
...
static void flushDecoder() {
	printf("shashi:decode:flushDecoder\n");
...
static void parsePlayStream(Stream *stream) {
	printf("shashi:decode:parsePlayStream\n");
...
static void playStream(Stream *stream) {
	printf("shashi:decode:playStream\n");
    av_init_packet(&packet);
...
u32 broadwayInit() {
	printf("shashi:decode:broadwayInit\n");
...
u32 broadwayGetMajorVersion() {
	printf("shashi:decode:broadwayGetMajorVersion\n");
    return 1;
}

u32 broadwayGetMinorVersion() {
	printf("shashi:decode:broadwayGetMinorVersion\n");
    return 1;
}
